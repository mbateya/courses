...
\usepackage{hyperref}
\hypersetup{
            pdftitle={Statistical\_Inference\_Project},
            pdfauthor={Mohammad Ateya},
            pdfborder={0 0 0},
            breaklinks=true}
...
\title{Statistical\_Inference\_Project}
...
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1} \OperatorTok{:}\StringTok{ }\DecValTok{1000}\NormalTok{) mns =}\StringTok{ }\KeywordTok{c}\NormalTok{(mns, }\KeywordTok{mean}\NormalTok{(}\KeywordTok{rexp}\NormalTok{(}\DecValTok{40}\NormalTok{,}\FloatTok{0.2}\NormalTok{)))}
\KeywordTok{hist}\NormalTok{(mns)}
\end{Highlighting}
\end{Shaded}

\includegraphics{statistical_inference_course_project_files/figure-latex/cars-1.pdf}
...
\includegraphics{statistical_inference_course_project_files/figure-latex/pressure-1.pdf}
